...
const btnDanger =
  "inline-flex items-center justify-center rounded-full border border-red-400/30 bg-red-500/10 px-3 py-1.5 text-xs font-semibold text-red-100 transition hover:bg-red-500/18 disabled:opacity-50";
...
export function ServiceListTable({
  ...
  return (
    <div className="mt-4">
          ...
          <table className="w-full min-w-[920px] text-left text-sm">
            ...
            <tbody className="divide-y divide-white/[0.06]">
              {pageItems.map((s) => {
                ...
                const deleting = id != null && deletingId === id;
                const active = s.isActive !== false;
                const rowKey = String(id ?? s.title);
      ...
      {services.length > 0 && pageItems.length === 0 ? (
...
/** @deprecated Use ServiceListTable */
export { ServiceListTable as AdminServiceTable };
